...
# Project:  ../Huffman/Huffman.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile ../Huffman/Huffman.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
INCPATH       = -I../Huffman -I. -isystem /usr/include/qt -isystem /usr/include/qt/QtCore -I. -I/usr/lib/qt/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
DISTDIR = /home/bjorked/Projects/C++/build-Huffman-Desktop-Debug/.tmp/Huffman1.0.0
LINK          = g++
LFLAGS        = 
...
SOURCES       = ../Huffman/src/main.cpp \
		../Huffman/src/node.cpp \
		../Huffman/src/encoder.cpp 
OBJECTS       = main.o \
		node.o \
		encoder.o
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		../Huffman/Huffman.pro ../Huffman/src/node.hpp \
		../Huffman/src/encoder.hpp ../Huffman/src/main.cpp \
		../Huffman/src/node.cpp \
		../Huffman/src/encoder.cpp
...
Makefile: ../Huffman/Huffman.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile ../Huffman/Huffman.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
distdir: FORCE
	...
	$(COPY_FILE) --parents ../Huffman/src/node.hpp ../Huffman/src/encoder.hpp $(DISTDIR)/
	$(COPY_FILE) --parents ../Huffman/src/main.cpp ../Huffman/src/node.cpp ../Huffman/src/encoder.cpp $(DISTDIR)/
...
main.o: ../Huffman/src/main.cpp ../Huffman/src/encoder.hpp \
		../Huffman/src/node.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o ../Huffman/src/main.cpp

node.o: ../Huffman/src/node.cpp ../Huffman/src/node.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o node.o ../Huffman/src/node.cpp

encoder.o: ../Huffman/src/encoder.cpp ../Huffman/src/encoder.hpp \
		../Huffman/src/node.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o encoder.o ../Huffman/src/encoder.cpp
